...
To achieve this dream, I decided to study computer science in 2020 back in Guam. After achieving my associates of science, I decided to move to Seattle to seek better opportunities. However, plans has changed and I wanted to settle in so I could get used to a new lifestyle. That decision pushed back my goal for 2 years, but then I saw an ad on instagram with the University of Washington partnering with Circuit Stream for a Game Development bootcamp. I decided to take the risk to get back on track and now I'm currently a student trying to achieve that same dream.
